...
# chrt -f 5 ./tau_1 -c 3 -t 10 -m 16 -n 2 --period 100 --jobs 100 \
# 	-i $((TX2_ITERS_16KB_10MS*2)) & # &> /dev/null &
# chrt -f 6 ./tau_2 -c 4 -t 10 -m 16 -n 1 --period 40  --jobs 200 \
# 	-i $((TX2_ITERS_16KB_10MS*1)) # &> /dev/null
#
# sleep 2
...
# 	sleep 1
# done
# mv trace.dat with_rtgang_normal.trace

echo -e "${GRN}[STATUS] Recording trace with RT-Gang (NPP)${NCL}"
taskset -c 1 trace-cmd record -e "sched_switch" &> /dev/null &
trace_pid=$!
sleep 5

chrt -f 5 ./tau_1 -c 3 -t 10 -m 16 -n 2 --period 100 --jobs 100 \
	-i $((TX2_ITERS_16KB_10MS*2)) -b & # &> /dev/null &
chrt -f 6 ./tau_2 -c 4 -t 10 -m 16 -n 1 --period 40  --jobs 200 \
	-i $((TX2_ITERS_16KB_10MS*1)) # &> /dev/null
...
mv trace.dat with_rtgang_npp.trace
