...
int main(int argc, char *argv[])
{
	 ...
	 */
	while ((opt = getopt_long(argc, argv, "m:n:a:t:c:r:p:i:j:l:w:hv:o",
		...
		case 'c': /* set CPU affinity */
			...
			break;
		case 'w': /* throttle best-effort tasks */
			be_wr_mbps = strtol(optarg, NULL, 0);
			register_gang_with_kernel(1001, 0, be_wr_mbps, be_wr_mbps);
			break;
